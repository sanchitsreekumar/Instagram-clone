...
function Modal() {
    ...
    const [openModal, setModalOpen]= useRecoilState(modalState);
    ...
    const uploadPost = async () =>{
        ...
        // get a download URL from firebase storage and update to original post with img
        /* this below code basically adds a doc to the database*/
        ...
        <Transition.Root show={openModal} as={Fragment}>
           ...
           >
              ...
              >
                ...
                {/* /* this element is to trick the browser into centering modal contents */ }
                <span
                ...
                >
                    <div
                    className='inline-block align-bottom bg-white rounded-lg px-4 pb-4 text-left
                    overflow-hiddwn shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm
                    sm:w-full sm:p-6'
                    >
                        ...
                        <div className='mt-3 text-center sm:mt-5'>
                            <Dialog.Title
                            as="h3"
                            className="text-lg leading-6 fond-medium text-gray-900"
                            >
                                Upload a photo
                            </Dialog.Title>
